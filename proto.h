...
PERL_CALLCONV unsigned	Perl_is_LC_MESSAGES_string_utf8(pTHX_ const char * string, const bool known_utf8);
#define PERL_ARGS_ASSERT_IS_LC_MESSAGES_STRING_UTF8	\
	assert(string)
PERL_CALLCONV unsigned	Perl_is_LC_MONETARY_string_utf8(pTHX_ const char * string, const bool known_utf8);
#define PERL_ARGS_ASSERT_IS_LC_MONETARY_STRING_UTF8	\
	assert(string)
PERL_CALLCONV unsigned	Perl_is_LC_NUMERIC_string_utf8(pTHX_ const char * string, const bool known_utf8);
#define PERL_ARGS_ASSERT_IS_LC_NUMERIC_STRING_UTF8	\
	assert(string)
PERL_CALLCONV unsigned	Perl_is_LC_TIME_string_utf8(pTHX_ const char * string, const bool known_utf8);
...
PERL_CALLCONV wchar_t	Perl_mbtowc(pTHX_ const wchar_t *, const char*, Size_t len);
#define PERL_ARGS_ASSERT_MBTOWC	\
	assert(wchar_t); assert(char)
...
#define PERL_ARGS_ASSERT_GET_LOCALE_STRING_UTF8NESS	\
	assert(string)
STATIC unsigned	S_get_nl_item_category_index(const item item);
